...
from controllers.application.ApplicationRegistration_controller import ApplicationRegistrationController
def addServiceLayer(api: Api):
    ...
    # Application
    api.add_resource(ApplicationRegistrationController, ApplicationRegistrationController.route)
